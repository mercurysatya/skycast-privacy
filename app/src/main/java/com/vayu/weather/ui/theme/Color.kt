...
val RainStart = Color(0xFF455A64)
val RainEnd = Color(0xFF263238)
val SnowStart = Color(0xFFE3F2FD)
val SnowEnd = Color(0xFFBBDEFB)
val FogStart = Color(0xFFB0BEC5)
val FogEnd = Color(0xFF90A4AE)
val ThunderStart = Color(0xFF1A237E)
val ThunderEnd = Color(0xFF0D47A1)
val NightStart = Color(0xFF0D47A1)
val NightEnd = Color(0xFF1A237E)

val GlassSunny = Color(0x40FFD54F)
val GlassRain = Color(0x404FC3F7)
val GlassSnow = Color(0x80E3F2FD)
val GlassStorm = Color(0x406080C0)
