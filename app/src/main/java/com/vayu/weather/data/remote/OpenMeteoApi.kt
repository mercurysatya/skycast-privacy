...
interface OpenMeteoApi {
    ...
    suspend fun getWeatherData(
        ...
        @Query("hourly") hourly: String = "temperature_2m,relative_humidity_2m,weather_code,pressure_msl,wind_speed_10m,visibility,precipitation_probability,wind_direction_10m,precipitation",
